...
<template>
  ...
  >
    <!-- Modal Content -->
    <div
      class="bg-white rounded-lg mx-auto px-[30px] md:px-0 md:max-w-[570px] shadow-lg p-8 relative"
    >
      <!-- Close Button -->
      <button @click="close" class="absolute text-xl font-bold top-2 right-2">
        &times;
      </button>
      ...
      <div class="flex justify-between">
        ...
        <!-- Favorite Button -->
        <button
          class="relative bg-white right-8"
