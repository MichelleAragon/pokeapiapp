...
<template>
  <div class="relative">
    <svg
      ...
      class="absolute left-3 top-[3.25rem] bg-white">
              <path
    ...
    <input
      type="text"
      placeholder="Search"
      v-model="searchTerm" @input="updateSearchTerm"
      class="text-sm font-medium text-dark w-full mb-[40px] rounded-[5px] h-[50px] outline-none mt-[35px] pl-[43px] font-custom bg-white"
    />
  </div>
</template>
